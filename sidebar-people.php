...
$categories=get_categories($cat_args);
  foreach($categories as $category) { 
    ...
    $posts=get_posts($args);
      if ($posts) {
        echo '<div class="accordion-group"><ul class="nav nav-list"><div class="accordion-heading"><a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion-categories" href="#collapse-' . $category->slug . '">' . $category->name.'</a></div>';
